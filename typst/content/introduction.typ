...
Una de las cosas que vamos a hacer es aprovechar la creciente potencia de cáculo en los microcontroladores para añadir al teclado la opción de comunicarse con el ordenador, de formar que se comunique con domótica @home-assistant de casa (u otros servicios). Esto es especialmente interesante a medio plazo, debido al auge del IoT.
