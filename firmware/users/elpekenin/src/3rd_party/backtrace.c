// FROM: https://github.com/red-rocket-computing/backtrace
...
static const unwind_index_t *unwind_search_index(const unwind_index_t *start, const unwind_index_t *end, uint32_t ip) {
    const unwind_index_t *middle;
