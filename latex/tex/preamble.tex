...
\hr
  ...
  \subsection{\LaTeX}
  Este informe está escrito en \LaTeX, para usarlo instalamos el software necesario con\newline
  \cli{sudo pacman -S texlive-most} \newline
  Para ver el PDF resultante, instalamos un visor minimalista \cli{sudo pacman -S mupdf}. \newline
  Como el compilado de \LaTeX incluye varios pasos, añadiremos una función\cite{pdf} a la configuracion de shell. Este comando se ejecuta haciendo simplemente \cli{pdf}. Funciona de forma silenciosa, redirigiendo la salida de los comandos para que no salgan por pantalla; y al terminar abre el archivo producido.
