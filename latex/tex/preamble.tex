...
\hr
    ...
    Como la ``compilación'' de \LaTeX incluye varios pasos, añadiremos una función\cite{pdf} a la configuracion de shell. Este comando se ejecuta haciendo simplemente \cli{pdf}. Funciona de forma silenciosa (redirige la salida de los comandos para que no salgan por pantalla) y al terminar abre el archivo producido.
